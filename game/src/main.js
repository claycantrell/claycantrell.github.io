...
const scripts = [
    ...
    './systems/entities/frog.js',
    './systems/entities/penguin.js',
    './systems/entities/panda.js',
    './systems/entities/crab.js',
    './systems/entities/butterfly.js',
    './systems/entities/salamander.js',
...
function getScriptName(src) {
    ...
    const names = {
        ...
        'bird': 'Wildlife (birds)',
        'frog': 'Wildlife (frogs)',
        'penguin': 'Wildlife (penguins)',
        'panda': 'Wildlife (pandas)',
        'crab': 'Wildlife (crabs)',
        'butterfly': 'Wildlife (butterflies)',
        'salamander': 'Wildlife (salamanders)',
